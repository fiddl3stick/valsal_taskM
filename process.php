...
if(isset($_POST["submitButton"])){
    ...
    $query = "INSERT INTO `user`(`student_id`, `fname`,`birthday`, `email`) VALUES ('$student_id','$fname','$birthday', '$email')";
    $query_result = mysqli_query( $con, $query );
...
if(isset($_POST["update"])){
    ...
    $query = "UPDATE `user` SET `student_id`='$student_id',`fname`='$fname',`birthday`='$birthday',`email`='$email',`date_Created`='$date_Created' WHERE `id` ='$id'";
